<template>
    <div class="modal-card" ref="modal">
        ...
        <section class="modal-card-body">
            <b-field>
                <b-input type="email" v-model="data.email" placeholder="E-mail" required></b-input>
            </b-field>
            <b-field>
                <b-input v-model="data.name" placeholder="Name" required></b-input>
            </b-field>
        </section>
